...
\begin{document}
	...
	\exemplaire{10}{    
		...
		\begin{minipage}{.4\linewidth}
			\centering\large\bf Test sur la matière\\ 18/09/2018\end{minipage}
		\champnom{\fbox{    
			...
			\begin{multicols}{2}
				...
				\begin{question}{matiere}    
					...
					\begin{reponses}		
						\mauvaise{de grains de sable.}\bareme{-0.5}
						\bonne{d'atomes.}\bareme{2}
						\mauvaise{d'air.}\bareme{-0.5}
						\mauvaise{de quatre éléments}\bareme{-0.5}
					\end{reponses}
				\end{question}
				...
				\begin{question}{etats}
					...
					\begin{reponses}
						\mauvaise{Rouge, Vert et Bleu}\bareme{-0.5}
						\bonne{Solide, Liquide et Gazeux}\bareme{2}
						\mauvaise{Résistant, Souple et Dur}\bareme{-0.5}
					\end{reponses}
				\end{question}
				...
				\begin{question}{volume}
					...
					\begin{reponses}
						\mauvaise{centimètre cube.}\bareme{-0.5}
						\mauvaise{mètre carré.}\bareme{-0.5}
						\bonne{mètre cube.}\bareme{2}
						\mauvaise{mètre.}\bareme{-0.5}
					\end{reponses}   
