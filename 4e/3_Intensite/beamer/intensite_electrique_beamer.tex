...
\begin{alertblock}{}
	...
	\begin{itemize}
		\item L'unité de mesure de l'\kw{intensité} électrique est l' \kw{ampère} (symbole $A$). \pause
		
		\item Un \kw{ampèremètre} permet de mesurer l'intensité du courant, il se branche \kw{en série} dans le circuit.\pause
