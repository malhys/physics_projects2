...
\begin{questions}
	\question 
		\begin{parts}
			\part Ce texte est un extrait d'un article scientifique provenant du site cnrs.fr. Il paraît fiable car le CNRS est le Centre National de la Recherche Scientifique. 
			
			\part D'après le document, les scientifiques ont réussi à faire circuler un courant électrique dans les molécules d'ADN et il possède une résistance électrique. Donc l'ADN est bien un conducteur électrique.
